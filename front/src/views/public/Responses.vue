...
<template>
  <div>
    <div class="mt-lg-5 mb-lg-5 pb-4 pt-lg-4 col-lg-11 m-auto poll-container">
      <div class="col-lg-11 headerBackground pt-4 pb-4 m-auto mt-lg-2">
        <!-- Logo -->
        <h1
          class="col-10 col-lg-10 col-xl-9 pb-3 m-auto logo text-white "
        ><a class=" text-white text-decoration-none" href="/"> BIGSCREEN</a>
         
        </h1>
        <!-- Display the created_at -->
        <p v-if="this.error == ''" class="fs-5 m-auto text-center col-9 col-lg-9 titlePoll text-white ">
      ...
      <p
        class="rounded-2 fw-bold p-5 mb-5 fs-4 bg-light text-center col-lg-8 m-auto"
        v-if="this.error != ''"
      >
        {{ this.error }}
      </p>
